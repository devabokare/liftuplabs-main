...
const signals = [
  {
    ...
    note: "Custom AI agents integrated into your business workflow for 24/7 engagement.",
  },
  {
    date: "TECH",
    title: "Web apps",
    note: "High-performance, SEO-friendly web applications built for scale and speed.",
  },
  {
    date: "CLOUD",
    title: "Cloud Services",
    note: "Reliable, scalable cloud infrastructure to power your applications and data.",
  },
  {
    date: "FLOW",
    title: "Consulting",
    note: "Workflow optimization and lead generation systems to boost efficiency.",
  },
  {
    date: "DESIGN",
    title: "UI/UX Design",
    note: "Precision design systems and responsive interfaces built in Figma.",
  },
]
...
export function SignalsSection() {
  ...
  return (
    <section id="signals" ref={sectionRef} className="relative py-32 px-6 md:px-12 max-w-7xl mx-auto">
      <div
        ref={cursorRef}
        className={cn(
      ...
      <div ref={headerRef} className="mb-20">
        <span className="font-mono text-[10px] uppercase tracking-[0.3em] text-accent">01 / Capabilities</span>
        <h2 className="mt-4 font-[var(--font-bebas)] text-5xl md:text-7xl tracking-tight uppercase">OUR SERVICES</h2>
      </div>
