...
export function ColophonSection() {
  ...
  return (
    <section
      ref={sectionRef}
      id="colophon"
      className="relative py-32 px-6 md:px-12 max-w-7xl mx-auto border-t border-border/30"
    >
      {/* Section header */}
      ...
      <div ref={gridRef} className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 md:gap-12">
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-2">
            <li className="font-mono text-xs text-foreground/80">LiftUpLabs</li>
            <li className="font-mono text-xs text-foreground/80">Creative Systems</li>
          </ul>
        </div>
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-2">
            ...
            <li className="font-mono text-xs text-foreground/80">OpenAI API</li>
          </ul>
        </div>
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-2">
            <li>
              <a
                href="mailto:hello@liftuplabs.com"
